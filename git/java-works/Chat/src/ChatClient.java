...
import java.net.UnknownHostException;
 ...
 public class ChatClient implements Runnable {
    ...
    public static void main(String[] args) {
        int portNo = 3333;
        String host = "localhost"; //Baglanılcak serverin ip adresi yazılır . Server ile client aynı bilgisayar ise localhost yazılır.
         if (args.length < 2) {
         ...
         */
        try {
            clientSocket = new Socket(host, portNo); //Client acılıyor
        ...
        if (clientSocket != null && ps != null && dis != null) {
            try {
                ...
                } //Sonsuz döngu ile mesaj yazılır.Çıkma komutu ile çıkana kadar.
                 ps.close();
                dis.close();
                clientSocket.close();
            } catch (IOException e) {
