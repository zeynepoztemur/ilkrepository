 ...
 */
public class denemeJFrame extends javax.swing.JFrame {
    ...
    public denemeJFrame(String para){
    ...
    private void initComponents() {
        ...
        setTitle("Hosgeldiniz");
        setLocation(new java.awt.Point(0, 15));
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter İnformations"));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seciniz", "Ankara", "Bursa", "Istanbul", "Sivas" }));
        ...
        jButton1.setBackground(new java.awt.Color(88, 144, 241));
        jButton1.setText("OK");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new denemeJFrame().setVisible(true);
            }
        });
    }
